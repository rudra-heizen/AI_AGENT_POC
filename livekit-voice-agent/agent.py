...
async def entrypoint(ctx: JobContext):
    ...
    print(system_prompt)
    print(first_message)
    # system_prompt = "You are a FAANG-level DSA interviewer. Ask medium to hard questions, give hints only when necessary, and evaluate correctness."
    # first_message = "Hi, thanks for joining. Let's start with a problem on arrays."
